...
const createSpringAnimation = (toValue, { spring }, animatedValue) => {
  return isBoolean(spring)
    ...
    : Animated.spring(animatedValue, { toValue, ...spring });
};
...
export const moveX = (
  ...
  const defaultMoveXValue = defaultTransformStyle(
    animationConfig,
    'translateX',
    ZERO
  );

  animatedValues[TRANSLATE_X] =
    animatedValues[TRANSLATE_X] || new Animated.Value(defaultMoveXValue);

  if (!finalAnimationsValues[TRANSLATE_X]) {
    finalAnimationsValues[TRANSLATE_X] =
      animatedValues[TRANSLATE_X]._value + animationConfig.value;
  } else {
    finalAnimationsValues[TRANSLATE_X] =
      finalAnimationsValues[TRANSLATE_X] + animationConfig.value;
  }

  let animation;

  if (get(animationConfig, 'options.spring')) {
    animation = createSpringAnimation(
      finalAnimationsValues[TRANSLATE_X],
...
export const moveY = (
  ...
  const defaultMoveYValue = defaultTransformStyle(
    animationConfig,
    'translateY',
    ZERO
  );

  animatedValues[TRANSLATE_Y] =
    animatedValues[TRANSLATE_Y] || new Animated.Value(defaultMoveYValue);

  if (!finalAnimationsValues[TRANSLATE_Y]) {
    finalAnimationsValues[TRANSLATE_Y] =
      animatedValues[TRANSLATE_Y]._value + animationConfig.value;
  } else {
    finalAnimationsValues[TRANSLATE_Y] =
      finalAnimationsValues[TRANSLATE_Y] + animationConfig.value;
  }
...
export const rotateX = (
  ...
  if (lastAnimationValues) {
    ...
    newInputRange = [0, 100];
    newOutputRange = [
      `${defaultTransformStyle(animationConfig, 'rotateX', ZERO_DEG)}`,
      `${animationConfig.value}deg`,
    ];
...
export const rotateZ = (
  ...
  if (lastAnimationValues) {
    ...
    newInputRange = [0, 100];
    newOutputRange = [
      `${defaultTransformStyle(animationConfig, 'rotateZ', ZERO_DEG)}`,
      `${animationConfig.value}deg`,
    ];
...
export const rotateY = (
  ...
  if (lastAnimationValues) {
    ...
    newInputRange = [0, 100];
    newOutputRange = [
      `${defaultTransformStyle(animationConfig, 'rotateY', ZERO_DEG)}`,
      `${animationConfig.value}deg`,
    ];
...
export const skewX = (
  ...
  if (lastAnimationValues) {
    ...
    newInputRange = [0, 100];
    newOutputRange = [
      `${defaultTransformStyle(animationConfig, 'skewX', ZERO_DEG)}`,
      `${animationConfig.value}deg`,
    ];
...
export const skewY = (
  ...
  if (lastAnimationValues) {
    ...
    newInputRange = [0, 100];
    newOutputRange = [
      `${defaultTransformStyle(animationConfig, 'skewY', ZERO_DEG)}`,
      `${animationConfig.value}deg`,
    ];
...
export const perspective = (animationConfig, animatedValues) => {
  animatedValues[PERSPECTIVE] =
    animatedValues[PERSPECTIVE] ||
    new Animated.Value(
      defaultTransformStyle(animationConfig, 'perspective', ONE)
    );
...
export const height = (
  ...
  animatedValues[HEIGHT] =
    animatedValues[HEIGHT] || new Animated.Value(animationConfig.height);

  if (!finalAnimationsValues[HEIGHT]) {
    finalAnimationsValues[HEIGHT] = animationConfig.value;
  } else {
    finalAnimationsValues[HEIGHT] =
      finalAnimationsValues[HEIGHT] + animationConfig.value;
  }
...
export const fontSize = (
  ...
  if (!finalAnimationsValues[FONT_SIZE]) {
    ...
    finalAnimationsValues[FONT_SIZE] =
      finalAnimationsValues[FONT_SIZE] + animationConfig.value;
  }
...
export const width = (
  ...
  animatedValues[WIDTH] =
    animatedValues[WIDTH] || new Animated.Value(animationConfig.width);

  if (!finalAnimationsValues[WIDTH]) {
    finalAnimationsValues[WIDTH] = animationConfig.value;
  } else {
    finalAnimationsValues[WIDTH] =
      finalAnimationsValues[WIDTH] + animationConfig.value;
  }
...
export const backgroundColor = (
  ...
  animatedValues[BACKGROUND_COLOR] =
    backgroundAnimatedValue || new Animated.Value(0);
  ...
  if (lastAnimationValues) {
    ...
    newInputRange = [0, 100];
    newOutputRange = [
      defaultStyle(animationConfig, 'backgroundColor', COLOR),
      animationConfig.value,
    ];
...
export const borderColor = (
  ...
  if (lastAnimationValues) {
    ...
    newInputRange = [0, 100];
    newOutputRange = [
      defaultStyle(animationConfig, 'borderColor', COLOR),
      animationConfig.value,
    ];
...
export const color = (
  ...
  if (lastAnimationValues) {
    ...
    newInputRange = [0, 100];
    newOutputRange = [
      defaultStyle(animationConfig, 'color', COLOR),
      animationConfig.value,
    ];
